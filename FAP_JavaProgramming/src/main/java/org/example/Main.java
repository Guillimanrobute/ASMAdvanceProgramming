...
import org.example.entity.BasicWage;
...
public class Main {
    public static void main(String[] args) {
        ...
        ScheduleService scheduleService = new ScheduleService.Builder()
                .addLesson(LocalDate.of(2023, 11, 25), "Advance Programming", "9:00 AM", "10:30 AM")
                .addLesson(LocalDate.of(2023, 11, 26), "IoT", "1:00 PM", "2:30 PM")
                .build();
        ...
        updateInfoRequest.updateInfoTea88
        //Facade ==Structural Pattern
        FacadeService facadeService = new FacadeService();
        facadeService.operationDeleteTeacher(1);

        //Decorator ==========
        WageInterface baseWageInterface = new BasicWage("John Doe", 5, 30);
